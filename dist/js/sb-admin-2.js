...
$(function() {
    ...
    if ( Cookies && Cookies.get('sidebar-closed') === '1' && !$('body').hasClass("sidebar-closed") && width >= 768) {
    ...
    $(window).bind("load resize", function() {
        ...
        if (width < 768) {
            ...
            /*
            if (Cookies) {
                if (Cookies.get('sidebar-closed') === 1 && !$('body').hasClass("sidebar-closed")) {
                    body.addClass("sidebar-closed");
